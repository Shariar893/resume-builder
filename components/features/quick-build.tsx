...
//       <div className="h-80  linear-mask-2 absolute ">
//         <FlashIcon />
//       </div>
...
const QuickBuild = () => {
  return (
    <div className="transform-gpu group relative shadow-[0_-20px_80px_-50px_#7877c64d_inset] border-[1px] border-[rgba(255, 255, 255, .1)] w-[35rem] rounded-md bg-[#09090b] h-[30rem] flex overflow-hidden">
